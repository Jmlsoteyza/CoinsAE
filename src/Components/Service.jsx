          ...
          <div className="service-description_position">
            <div className="service-description_innercontainer">
              ...
              <div className="text-block">
                ...
                <p>
                  ...
                  secure. You can be confident that your financial information
                  and assets will be protected from potential threats.
                </p>
              </div>
            </div>
            <div className="service-description_innercontainer">
              <div className="service-circle-style">
                <img src={LowcostLogo} className="logothis" alt="service" />
              </div>
              <div className="text-block">
                <h1>Low cost</h1>
                <p>
                  Our crypto.AE offers low-cost services for buying and selling
                  cryptocurrencies. You can save money on transaction fees and
            ...
            <div className="service-description_innercontainer">
              ...
              <div className="text-block">
                ...
                <p>
                  Our crypto.AE website is protected by insurance, giving you
                  added peace of mind when using our platform to buy and sell
                  cryptocurrencies.
                </p>
              </div>
            </div>
            <div className="service-description_innercontainer">
              ...
              <div className="text-block">
                ...
                <p>
                  Our crypto website allows you to easily transfer money to
                  other users on our platform. With just a few clicks.
                </p>
              </div>
            </div>
            </div>
